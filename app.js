(function () {
  ...
  function renderAbout() {
    ...
    html += `<a class="about-link" href="https://discord.gg/aR5pXyVG3V" target="_blank" rel="noopener noreferrer">${discordIcon}<span><span class="about-link-title">Join our Discord</span><br><span class="about-link-text">Chat, request anime, get updates</span></span></a>`;
    html += `<a class="about-link" href="https://github.com/aluukill/AniCult" target="_blank" rel="noopener noreferrer">${githubIcon}<span><span class="about-link-title">Source on GitHub</span><br><span class="about-link-text">Report issues, star the project</span></span></a>`;
    html += `</div>`;
    html += `</div>`;
