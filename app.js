(function () {
  ...
  function renderAbout() {
    ...
    html += `<a class="about-row" href="https://www.instagram.com/aluukill/" target="_blank" rel="noopener noreferrer">${instagramIcon}<span class="about-card-text"><span class="about-link-title">Instagram</span><span class="about-link-text">@aluukill</span></span></a>`;
